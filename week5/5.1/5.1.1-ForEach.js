...
// 1 using forEach, print a list of cities from the data
console.log("// List of Cities(using forEach)");
data.forEach(user => {
  console.log(user.address.city);
});
data.forEach(user => {
  console.log(`gamer named ${user.name}, real name is ${user.username}`);
})
// // second way to do this is using map
...
const newArray = []
data.forEach(user => {
  newArray.push(`company: ${user.company.name};
...
weeks.forEach(week => week.textContent = "Best week Ever")
